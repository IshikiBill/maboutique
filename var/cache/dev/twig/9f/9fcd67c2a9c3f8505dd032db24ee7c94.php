...
\t\t\t";
    ...
    {
        return array (  450 => 227,  432 => 128,  414 => 17,  394 => 11,  382 => 227,  377 => 225,  372 => 223,  330 => 184,  307 => 164,  301 => 161,  295 => 158,  284 => 150,  280 => 149,  258 => 129,  252 => 128,  244 => 122,  219 => 100,  210 => 94,  200 => 87,  191 => 81,  182 => 75,  171 => 66,  169 => 65,  159 => 58,  155 => 57,  152 => 56,  147 => 54,  141 => 52,  136 => 50,  131 => 48,  126 => 47,  124 => 46,  117 => 42,  111 => 39,  105 => 36,  92 => 28,  83 => 22,  79 => 21,  74 => 18,  70 => 17,  66 => 16,  61 => 13,  59 => 11,  47 => 1,);
    }
...
\t\t<meta name=\"generator\" content=\"Jekyll v4.1.1\">
\t\t<title>
\t\t\t{% block title %}La Boutique Ishiki- Boutique de lithothérapie française
\t\t\t{% endblock %}
\t\t</title>


\t\t<link href=\"{{asset('assets/css/bootstrap.min.css')}}\" rel=\"stylesheet\">
\t\t<link rel=\"stylesheet\" href=\"{{ asset ('assets/css/ishikiShop.css')}}\"> {% block javascript %}{% endblock %}
...
\t\t\t<a class=\"navbar-brand\" href=\"{{ path('app_home') }}\"><img height=\"50\" src=\"{{ asset ('assets/img/1.png') }} \" alt=\"Bienvenue sur la page d'acceuil du site Ishiki-shop, site de lithothérapie\">
\t\t\t\tIshiki-Shop</a>
\t\t\t<button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarCollapse\" aria-controls=\"navbarCollapse\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
\t\t\t\t<span class=\"navbar-toggler-icon\"></span>
\t\t\t</button>
...
\t\t\t\t\t</li>
\t\t\t\t\t<li class=\"nav-item active\">
\t\t\t\t\t\t<a class=\"nav-link\" href=\"{{ path ('app_ishiki')}}\">Qui sommes-nous?</a>
\t\t\t\t\t</li>
\t\t\t\t\t<li class=\"nav-item active\">
...
\t\t\t\t<div class=\"carousel-inner\">
\t\t\t\t\t<div class=\"carousel-item active\">
\t\t\t\t\t\t<svg class=\"bd-placeholder-img\" width=\"100%\" height=\"100%\" xmlns=\"http://www.w3.org/2000/svg\" preserveaspectratio=\"xMidYMid slice\" focusable=\"false\" role=\"img\"><img src=\"{{ asset('assets/img/buddha.jpg') }}\" alt=\"image Buddha\"><rect width=\"100%\" height=\"100%\" fill=\"#777\"/></svg>
\t\t\t\t\t\t<div class=\"container\">
\t\t\t\t\t\t\t<div class=\"carousel-caption text-left\">
\t\t\t\t\t\t\t\t<h1>Bienvenue sur Ishiki-Shop</h1>
\t\t\t\t\t\t\t\t<p>\"Les pierres ont un pouvoir caché, laissez-les vous guider sur le chemin de la guérison.\"</p>
\t\t\t\t\t\t\t\t<p>
\t\t\t\t\t\t\t\t\t<a class=\"btn btn-lg btn-primary\" href=\"{{ path ('app_account')}}\" role=\"button\">Inscrivez-vous dès aujourd'hui !</a>
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"carousel-item\">
\t\t\t\t\t\t<svg class=\"bd-placeholder-img\" width=\"100%\" height=\"100%\" xmlns=\"http://www.w3.org/2000/svg\" preserveaspectratio=\"xMidYMid slice\" focusable=\"false\" role=\"img\"><img src=\"{{ asset('assets/img/zen.jpg') }}\" alt=\" image zen\"><rect width=\"100%\" height=\"100%\" fill=\"#777\"/></svg>
\t\t\t\t\t\t<div class=\"container\">
\t\t\t\t\t\t\t<div class=\"carousel-caption\">
\t\t\t\t\t\t\t\t<h1>Connaissez-vous la lithothérapie?.</h1>
\t\t\t\t\t\t\t\t<p>A travers notre boutique de lithothérapie, nous allons proposé une méthode de soins avec des pierres, disposant de vertus différentes. La lithothérapie est, en quelques mots, une méthode de soin naturelle par les pierres, Le mot est formé des deux termes grecs lithos (pierre) et thérapeia (cure). Le postulat de la lithothérapie est qu’il est possible d’influencer son état physique et psychique grâce à l’énergie dégagée par les pierres, principalement sous formes de vibrations.
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t<p>
\t\t\t\t\t\t\t\t\t<a class=\"btn btn-lg btn-primary\" href=\"{{ path ('app_learn_more')}}\" role=\"button\">En apprendre plus</a>
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"carousel-item\">
\t\t\t\t\t\t<svg class=\"bd-placeholder-img\" width=\"100%\" height=\"100%\" xmlns=\"http://www.w3.org/2000/svg\" preserveaspectratio=\"xMidYMid slice\" focusable=\"false\" role=\"img\"><img src=\"{{ asset('assets/img/candlelight-2826332_1920.jpg') }}\" alt=\"image d'une bougie\"><rect width=\"100%\" height=\"100%\" fill=\"#777\"/></svg>
\t\t\t\t\t\t<div class=\"container\">
\t\t\t\t\t\t\t<div class=\"carousel-caption text-right\">
\t\t\t\t\t\t\t\t<h1>Bougie de lithothérapie.</h1>
\t\t\t\t\t\t\t\t<p>Avec la chaleur de la flamme de votre bougie, vous allez décupler les vertus des cristaux. Offrez ou offrez-vous un moment de détente, d'harmonisation, de purification de soin énergétique, chasser les énergies négatives ou d'alignement des chakras suivant la bougie et les pierres de lithothérapie choisies.</p>
...
", "base.html.twig", "C:\\Users\\malkh\\Desktop\\Ishiki.test\\maboutique\\templates\\base.html.twig");
    }
}
