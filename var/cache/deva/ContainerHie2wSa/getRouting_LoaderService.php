 ...
 */
class getRouting_LoaderService extends App_KernelDevaDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->load('getAnnotations_CachedReaderService')), 'deva');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'deva'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'deva'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'deva'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'deva'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'deva'));
