 ...
 */
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevaDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhost938c439', fn () => \EntityManagerGhost938c439::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
