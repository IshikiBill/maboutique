...
class Product extends \App\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'slug', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'illustration', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'subtitle', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'prix', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'category', '' . "\0" . 'App\\Entity\\Product' . "\0" . 'isBest'];
        }
    ...
    public function isIsBest(): ?bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isIsBest', []);

        return parent::isIsBest();
    }
