  ...
  public function index(Request $request): Response
  {
    ...
    if ($request->get('email')) {
      ...
      if ($user) {
        ...
        // 2: Envoyer un email à l'utilisateur avec un lien lui permettanr de mettre à jour son mot de passe.
        ...
        $this->addFlash('notice', 'Vous allez recevoir un mail dans quelques secondes, afin de reinitialiser votre mot de passe.');
      } else {
